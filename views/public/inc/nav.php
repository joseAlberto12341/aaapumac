            ...
            <div class="nav-menu">
                ...
                <div class="menu-items">
                    <ul>
                        ...
                        <?php endif; ?>
                        <li><a href="/public/jobs">Bolsa de Trabajo</a><ul class="submenu"></ul></li>
                        <li><a href="/public/contact">Contacto</a></li>
                        <li><a href="/public/capacitacion">Capacitación</a></li>
                        <li><a href="/public/politica">Nuestra Política</a></li>
                        <li><a href="/public/report">Reporte Antisoborno</a></li>
                        <!-- <li><a href="/public/aaaweb">Aaapumac Web</a></li> -->
                        <?php if (!isset($_SESSION['logged']) || $_SESSION['logged'] !== true): ?>
                            <li>
                        ...
                        <?php else: ?>
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="/client/home">Asociado</a></li>
...
<div class="chat-icon" id="chat-icon">
    <img src="/src/views/assets/img/illustration/imagotipo_logo.png" alt="Chatbot" style="width: 60px; height: auto;">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#send-btn").on("click", function () {
            ...
            $.ajax({
                url: '../src/views/public/inc/chat.php',
                type: 'GET',
