<section class="faq-section section-gap with-illustration with-shape grey-bg">
    <div class="container">
        <div class="faq-illustration-img">
            <img src="/src/views/assets/img/illustration/03.png" alt="illustration">
        </div>
        ...
        <div class="circle-img" style="background-image: url(src/views/assets/img/faq-circle.png);"></div>
    </div>
</section>