                            ...
                            <tr>
                                <td class="text-center" style="white-space: nowrap;">
                                    <div class="d-flex justify-content-center">
                                        <form method="post" action="/admin/producMas" class="me-1">
                                        ...
                                        <form method="post" action="/admin/producMenos">
                                            <input type="hidden" name="id_producto" value="<?php echo $i->getId(); ?>">
                                            <button type="submit" name="tipoMovimiento" value="salida"
                                                style="display: inline-block; padding: 6px 12px; border: 1px solid #dc3545; border-radius: 4px; background-color: #f0f8ff; color: #dc3545; text-decoration: none;"
                                                onmouseover="this.style.backgroundColor='#dc3545'; this.style.color='#fff';"
                                                onmouseout="this.style.backgroundColor='#f0f8ff'; this.style.color='#dc3545';">
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px; overflow: hidden;">
            ...
            <div class="modal-body" style="padding: 2rem;">
                <form method="post" id="productos" enctype="multipart/form-data" action="/admin/NewProduc">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="description" class="form-label">Cantidad de Productos</label>
                        <div class="input-group">
...
<script>
    document.getElementById('productos').addEventListener('submit', function (e) {
        ...
        Swal.fire({
            title: "Buen Trabajo!",
            text: "El pruducto nuevo se ha sido agregado exitosamente!",
            icon: "success",
