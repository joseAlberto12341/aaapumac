  ...
  <div style="background-color: #003366;"
    ...
    <div>
      <a class="navbar-brand brand-logo" href="../">
        <img src="/src/views/assets/img/logo-2.png" alt="logo" style="width: auto; height: 25px;" />
      </a>
      <a class="navbar-brand brand-logo-mini" href="/admin">
        <img src="/src/views/assets/img/logo-aa.png" alt="logo" style="width: auto; height: 30px;" />
      </a>
    </div>
  </div>
    ...
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text" style="color: #ffffff;">Buen día, <span
            class="text-black fw-bold"><?php echo $_SESSION['username']; ?></span>
        </h1>
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link count-indicator" id="notificationDropdown" href="#" data-bs-toggle="dropdown">
          <i class="icon-mail icon-lg" style="color: white;"></i>
        </a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <img src="/src/views/assets/images/faces/face10.jpg" alt="image" class="img-sm profile-pic">
            </div>
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <img src="/src/views/assets/images/faces/face12.jpg" alt="image" class="img-sm profile-pic">
            </div>
            <div class="preview-item-content flex-grow py-2">
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <img src="/src/views/assets/images/faces/face1.jpg" alt="image" class="img-sm profile-pic">
            </div>
            <div class="preview-item-content flex-grow py-2">
      ...
      <li class="nav-item dropdown d-none d-lg-block user-dropdown">
        <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
          <img class="img-xs rounded-circle" src="/src/views/assets/images/faces/face8.jpg" alt="Profile image"> </a>
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
          <div class="dropdown-header text-center">
            <img class="img-md rounded-circle" src="/src/views/assets/images/faces/face8.jpg" alt="Profile image">
          ...
          <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-help-circle-outline text-primary me-2"></i>
            FAQ</a>
          <a href="/login/logout" class="dropdown-item" href="/"><i
