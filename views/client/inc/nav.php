  ...
  <div style="background-color: #003366;" class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    ...
    <div>
      <a class="navbar-brand brand-logo" href="../">
        <img src="/src/views/assets/img/logo-2.png" alt="logo" />
      </a>
      <a class="navbar-brand brand-logo-mini" href="/admin">
        <img src="/src/views/assets/img/logo-aa.png" alt="logo" />
      </a>
    </div>
  </div>
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <li class="nav-item dropdown d-none d-lg-block user-dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
          ...
          <a class="dropdown-item" href="/client/profile"><i
          ...
          <!-- <a class="dropdown-item" href="/"><i
              class="dropdown-item-icon mdi mdi-account-edit text-primary me-2"></i>Editar perfil</a> -->
