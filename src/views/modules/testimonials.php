<section class="testimonial-section-three bg-img-c"
                ...
                <div class="testimonial-items" id="testimonialSliderThree">
                    <div class="testimonial-item text-center">
                        <div class="author-thumb">
                            <img src="src/views/assets/img/testimonial/author-9.png" alt="image">
                        </div>
...
<section class="testimonial-section grey-bg">
    ...
    <div class="testimonial-img">
        <img src="src/views/assets/img/testimonial/testimonial.png" alt="testimonial">
    </div>
</section>