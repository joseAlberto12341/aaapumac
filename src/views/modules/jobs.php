...
<div class="job-list-wrapper">
    <div class="row">
        <?php 
        // Acceder correctamente a los jobs desde $answer
        $jobs = $answer['jobs'] ?? [];
        ?>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="job-card">
                        ...
                        <div class="job-text">
                            <h4 class="job-title">
                                <!-- Enlace corregido -->
                                <a href='/Aaapumac/public/<?php echo $j->getId(); ?>/job/'>
                                    <?php echo $j->getTitle(); ?>
                                </a>
                            </h4>
        ...
        <?php else: ?>
            <div class="col-12">
                <p style="font-size:18px; color:#888;">No hay vacantes disponibles en este momento.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
