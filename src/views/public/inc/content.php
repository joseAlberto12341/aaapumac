<div class="col-sm-12">
  <div class="home-tab">
    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
      <ul class="nav nav-tabs" role="tablist"> <!--Botones de Navegación en Pestañas-->
        <li class="nav-item">
    ...
    <div class="tab-content tab-content-basic"> <!--Contenido de Pestañas-->
      <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
        <!--Contenido de Pestaña Overview-->
        <div class="row"><!-- Primer renglón de contenido - Panel de Numeración y Porcentajes-->
          <div class="col-sm-12">
        ...
        <div class="row"><!-- Segundo renglón de contenido - Panel de Gráficas-->
        ...
        <div class="row"><!-- Tercer renglón de contenido - Panel de Gráficas-->
          <div class="col-lg-8 d-flex flex-column">
            <div class="row flex-grow">
                  ...
                  <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-start">
                      <div>
                        ...
                        <p class="card-subtitle card-subtitle-dash">Lorem ipsum dolor sit amet consectetur adipisicing
                          elit</p>
                      </div>
                      <div>
                        <div class="dropdown">
                      ...
                      <table class="table select-table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div class="d-flex ">
                                <img src="/Aaapumac/src/views/assets/images/faces/face1.jpg" alt="">
                                <div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex">
                                <img src="/Aaapumac/src/views/assets/images/faces/face2.jpg" alt="">
                                <div>
                                  <h6>Laura Brooks</h6>
                                  <p>Head admin</p>
                                </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex">
                                <img src="/Aaapumac/src/views/assets/images/faces/face3.jpg" alt="">
                                <div>
                                  <h6>Wayne Murphy</h6>
                                  <p>Head admin</p>
                                </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex">
                                <img src="/Aaapumac/src/views/assets/images/faces/face4.jpg" alt="">
                                <div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="d-flex">
                                <img src="/Aaapumac/src/views/assets/images/faces/face5.jpg" alt="">
                                <div>
                      ...
                      <div class="col-lg-12">
                        ...
                        <div class="mt-3">
                          <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                            <div class="d-flex">
                              <img class="img-sm rounded-10" src="/src/views/assets/images/faces/face1.jpg"
                                alt="profile">
                          ...
                          <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                            <div class="d-flex">
                              <img class="img-sm rounded-10" src="/src/views/assets/images/faces/face2.jpg"
                                alt="profile">
                              <div class="wrapper ms-3">
                          ...
                          <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                            <div class="d-flex">
                              <img class="img-sm rounded-10" src="/src/views/assets/images/faces/face3.jpg"
                                alt="profile">
                              <div class="wrapper ms-3">
                          ...
                          <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                            <div class="d-flex">
                              <img class="img-sm rounded-10" src="/src/views/assets/images/faces/face4.jpg"
                                alt="profile">
                              <div class="wrapper ms-3">
                          ...
                          <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                            <div class="d-flex">
                              <img class="img-sm rounded-10" src="/src/views/assets/images/faces/face5.jpg"
                                alt="profile">
                              <div class="wrapper ms-3">
      ...
      <div class="tab-pane fade show active" id="more" role="tabpanel" aria-labelledby="more">
