...
<nav class="sidebar-modern" id="sidebar">
    ...
    <div class="sidebar-menu">
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoCoordinador/aso">
            ...
            <!-- Arancelario -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoCoordinador/convenio">
                    <div class="nav-icon gradient-purple">
                        <i class="mdi mdi-window-shutter-cog"></i>
                    </div>
                    <span class="nav-text">Entrega de pedimentos <br> gestiones</span>
                </a>
            </li>
        <!-- Arancelario -->
            <li class="nav-item">
        ...
        <!-- Arancelario -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoCoordinador/convenio">
                    ...
                    <span class="nav-text">Pedimentos finalizados</span>
                </a>
            </li>
        <!-- Arancelario -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociado/convenio">
                    <div class="nav-icon gradient-purple">
                        <i class="mdi mdi-window-shutter-cog"></i>
                    </div>
                    <span class="nav-text">contacto Aaapumac</span>
                </a>
            </li>
                    <!-- Arancelario -->
            <li class="nav-item">
                <a class="nav-link" href="/Aaapumac/asociadoCoordinador/listadoPersonal">
                    <div class="nav-icon gradient-purple">
                        <i class="mdi mdi-window-shutter-cog"></i>
                    </div>
                    <span class="nav-text">Gestion de<br>personal</span>
                </a>
            </li>
